...
public class Solution {
    ...
    public void search(char[][] board, int x, int y, TrieNode root, ArrayList ans, String res) {    
        ...
        if(x = board.length || y < 0 || y >= board[0].length || board[x][y]==0 || root == null)
            return ;
    ...
    public ArrayList wordSearchII(char[][] board, ArrayList<String> words) {

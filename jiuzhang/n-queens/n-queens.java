...
class Solution {
    ...
    private void solveNQueensCore(ArrayList> resultList,
                              int[] row,
                              int n,
                              int index) {
        if (index == n) {
            ArrayList singleResult = translateString(row);
    ...
    private ArrayList translateString(int[] row) {
        ArrayList resultList = new ArrayList<>();

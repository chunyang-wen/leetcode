...
public class Solution {
    public List> findLadders(String start, String end,
            Set dict) {
        List> ladders = new ArrayList<List<String>>();
        Map> map = new HashMap<String, List<String>>();
        Map distance = new HashMap<String, Integer>();
    ...
    void dfs(List> ladders, List<String> path, String crt,
            String start, Map distance,
            Map> map) {
        path.add(crt);
        if (crt.equals(start)) {
    ...
    void bfs(Map> map, Map<String, Integer> distance,
            String start, String end, Set dict) {
    ...
    List expand(String crt, Set<String> dict) {
